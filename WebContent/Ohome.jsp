...
<body>
	...
	<script type="text/javascript">
		window.open('viewPlayer.jsp','_self');
	</script>
	<%
		}
	%>
	<div class="container">
		...
		<div class="row">
			...
			<div
				...
				<div class="tab-pane fade in active" id="login">
					<form action="officer.jsp" method="post">
		...
		<div class="row mfoot">
			<div class="col-md-12">
				<button type="button" onclick="window.open('index.jsp','_self')" class="btn btn-default">Player</button>
			</div>
		</div>
	</div>
